...
| 조건 | 권장 프레임워크 | 이유 |
|------|----------------|------|
| 빠른 프로토타입 | Next.js 16 (App Router) | 파일 기반 라우팅, SSR/SSG, React Compiler |
...
**React 계열**:
- Next.js 16 (권장) - 풀스택, SSR/SSG, React Compiler 내장
...
| 방식 | 권장 도구 | 특징 |
|------|----------|------|
| Utility-first | Tailwind CSS v4 | 최신 버전, 성능 개선, 가장 인기 |
