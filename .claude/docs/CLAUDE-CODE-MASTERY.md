...
> **버전**: 1.0.0
> **최종 수정**: 2026-01-04
> **원천**: Boris Cherny의 12가지 팁 + [공식 문서](https://code.claude.com/docs) + 실전 패턴 분석
...
| 2 | Opus 4.5 우선 | 첫 시도 정확성 > 속도 | 모든 언어 |
| 3 | CLAUDE.md 활용 | 팀 지식 저장소 | 모든 언어 |
| 4 | PR 문서 자동화 | GitHub Action | 모든 언어 |
| 5 | Plan Mode 우선 | 계획 → 실행 | 모든 언어 |
| 6 | 슬래시 커맨드 | 반복 작업 자동화 | 모든 언어 |
| 7 | 서브 에이전트 | 작업 전문화 | 모든 언어 |
| 8 | PostToolUse 훅 | 포맷팅 자동화 | 언어별 도구 |
| 9 | 권한 화이트리스트 | 보안과 편의 균형 | 언어별 명령어 |
| 10 | MCP 연결 | 외부 도구 통합 | 모든 언어 |
| 11 | 백그라운드 실행 | 긴 작업 비동기 처리 | 모든 언어 |
| 12 | 검증 수단 제공 | 피드백 루프 | 언어별 테스트 |
