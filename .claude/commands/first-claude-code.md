...
```
대상: Claude Code가 뭔지 전혀 모르는 완전 초보자
목적: "와, 이게 되네?" 경험 제공
방식: 프로젝트 생성 과정에서 Claude Code 능력을 자연스럽게 보여줌
```
...
| 커맨드                 | 대상                                | 목적                            |
| ---------------------- | ----------------------------------- | ------------------------------- |
| `/first-claude-code`   | 완전 초보 (Claude Code가 뭔지 모름) | "내가 뭘 할 수 있는지 보여줄게" |
| `/learn-claude-code`   | 조금 아는 사람                      | 기능 학습                       |
| `/setup-claude-code`   | 적용했지만 부족한 사람              | 설정 생성                       |
| `/upgrade-claude-code` | 트렌드 쫓는 사람                    | 최신화                          |
...
```
검색어: "best web tech stack 2026", "Next.js 16 features"
```
...
| 항목         | 선택                    | 이유                                   |
| ------------ | ----------------------- | -------------------------------------- |
| 프레임워크   | Next.js 16 (App Router) | 가장 널리 사용, 풀스택, React Compiler |
| 언어         | TypeScript              | 타입 안전                              |
